 ...
 */
public class StorefrontDate implements java.io.Serializable{
    private int myYear;
    private int myMonth;
    private int myDay;
    private int myHour;
    ...
    /**
     * Default constructor. Creates an StorefrontDate object with all fields initialized
     * to the current date and hour.
     */
    public StorefrontDate()
    {
    ...
    /**
     * Alternate constructor. This will create a new StorefrontDate object with
     ...
     */
    public StorefrontDate(int year, int month, int day, int hour)
    {
        myYear = year;
    ...
    /**
     * This will take an StorefrontDate object and compare it to this StorefrontDate object. Will
     * return true if:
     ...
     */
    public boolean isSameDay(StorefrontDate theDate)
    {
     ...
     */
    public boolean isSameMonth(StorefrontDate theDate)
    {
        return (theDate.myMonth == myMonth && theDate.myYear == myYear);
    }
    
    /**
     * This will take an StorefrontDate object and check to see if the passed in object less than
     ...
     */
    public boolean isWithinYear(StorefrontDate theDate)
    {
    ...
    /**
     * @returns true if the date given is the same date or after this StorefrontDate
     * @returns false if the date is before
     */
    public boolean isSameOrAfterDate(StorefrontDate theDate){
    ...
    /**
     * @returns true if the date given is the before this StorefrontDate
     * @returns false if the date is the same date of after this StorefrontDate
     */
//    public boolean isBeforeDate(StorefrontDate theDate){
//    	int aucDate = this.myYear*1000000 + this.myMonth*10000 + this.myDay*100 + this.myHour;
//    	int paramDate = theDate.myYear*1000000 + theDate.myMonth*10000 + theDate.myDay*100 + theDate.myHour;
//    	if(paramDate < aucDate) return true;
//    	return false;
...
//    }
     ...
     */
    public boolean isTwoOrMoreDaysBefore(StorefrontDate theDate)
    {
...
//    	return 2;
     ...
     * @return false if the param date is 1 day before, is the day, of after this date
     */
    public boolean isTwoOrMoreDaysBeforeBid(StorefrontDate theDate)
    {
    	LocalDate thisDate = LocalDate.of(this.myYear, Month.of(this.myMonth), this.myDay);
    	LocalDate paramDate = LocalDate.of(theDate.myYear, Month.of(theDate.myMonth), theDate.myDay);
    	long daysBetween = ChronoUnit.DAYS.between(paramDate, thisDate);
...
//    	return 2;
    ...
    public StorefrontDate getStorefrontDateXDaysAway(int daysOut){
    	LocalDate temp1 = this.toLocalDate();
    	LocalDate temp2;
    	if(daysOut < 0) temp2 = temp1.minusDays(Math.abs(daysOut));
    	else temp2 = temp1.plusDays(daysOut);
    	return new StorefrontDate(temp2.getYear(), temp2.getMonthValue(), temp2.getDayOfMonth(), this.myHour);
    }
    ...
    /**
     * This function will take an StorefrontDate object and check whether it is 
     * within a specified amount of hours, positive and negative, from the date
     * object it is called on. Will return true if:
     *      -The passed in StorefrontDate is more than X hours before, or X hours
     *       after this StorefrontDate
     *      -The passed in StorefrontDate is exactly X hours before, or X hours
     *       after this StorefrontDate
     * Otherwise will return false.
     * 
     * @param theDate The date to compare against
     ...
     */
    public boolean isWithinXHours(StorefrontDate theDate, int hours)
    {
